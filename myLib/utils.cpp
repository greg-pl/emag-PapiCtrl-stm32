...
extern "C" void memDump(uint32_t adr, uint8_t *ptr, int cnt) {
...
static uint8_t tabMs[12] = { 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
...
const uint8_t DayTab[12] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
const uint8_t DayTabP[12] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
